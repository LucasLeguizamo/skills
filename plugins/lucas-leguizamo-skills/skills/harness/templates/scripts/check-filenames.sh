...
while IFS= read -r path; do
  ...
  name="${path##*/}"
  case "$name" in
    README.md|AGENTS.md|CLAUDE.md|pull_request_template.md|CODEOWNERS|LICENSE|CHANGELOG.md|SECURITY.md|CONTRIBUTING.md|Makefile) continue ;;  # names another tool fixes
  esac
